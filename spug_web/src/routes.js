...
export default [
  ...
  {
    icon: <CloudServerOutlined/>, title: '应用管理', auth: 'application.view', child: [
      {title: '项目管理', auth: 'application.project.view', path: '/application/project', component: () => import('./pages/application/project')},
      {title: '需求管理', auth: 'application.requirement.view', path: '/application/requirement', component: () => import('./pages/application/requirement')},
    ]
  },
  {
    icon: <CloudServerOutlined/>, title: '物料管理', auth: 'material.view', child: [
      {title: '物料分类', auth: 'material.category.view', path: '/material/category', component: () => import('./pages/material/category')},
      {title: '物料列表', auth: 'material.view', path: '/material/material', component: () => import('./pages/material/material')},
    ]
  },
  {
